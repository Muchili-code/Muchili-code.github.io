  ...
  <main class="nav-main">
      ...
      <div id="cat-tools" class="category-box">
          ...
          <div class="grid-wrapper">
              ...
              <a href="https://nav.sufine.top/" target="_blank" class="nav-card"><img loading="lazy" decoding="async" class="icon-img" src="../images/sufine.png" onerror="this.src='default.svg'"><div class="title">云渡书舟</div><div class="desc">实用站点导航</div></a>
